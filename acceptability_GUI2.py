...
class AcceptabilityGUI2(GeneralGUI):
...
class UpperFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent : AcceptabilityGUI2):
    ...
    def reset_upper_frame(self, GUI : AcceptabilityGUI2):
...
class ImageCanvasLeft(ctk.CTkCanvas):
    ...
    def __init__(self, parent : UpperFrame, GUI : AcceptabilityGUI2):
    ...
    def reset_image(self, GUI : AcceptabilityGUI2):
        self.im = ctk.CTkImage(Image.open(GUI.situation.im1_path), size = (470,470))
...
class TextBox(ctk.CTkTextbox):
    ...
    def reset_text(self, GUI : AcceptabilityGUI2):
        self.adapt_text(GUI) #on affiche les valeurs si disp_values = True
    ...
    def adapt_text(self, GUI : AcceptabilityGUI2):
...
class LowerFrame(ctk.CTkFrame):
    ...
    def reset_sliders(self, GUI : AcceptabilityGUI2):
        self.button_frame.reset(GUI)

class EvalFrame(ctk.CTkFrame):

    def __init__(self, parent : ctk.CTkFrame, GUI : AcceptabilityGUI2):
    ...
    def change_slider_state(self, GUI : AcceptabilityGUI2):
    ...
    def reset(self, GUI : AcceptabilityGUI2):
        #self.slider.configure(button_color="#C0C0C0", state="disabled")
        self.slider.set(0)
...
if __name__ == "__main__" : 
    ...
    interface = AcceptabilityGUI2(situation_list)
    interface.mainloop()
