...
class OptionFrame1(ctk.CTkFrame):
    def __init__(self, parent : ChoiceSituationGUI, _relx, _rely, _relwidth, _relheight):
        ...
        if parent.disp_values :
            self.title = f"Prioriser la valeur \"{parent.situation.value1.name_fr}\""
            self.label = ctk.CTkLabel(master=self, text=self.title, font = ctk.CTkFont(size=18, weight="bold"))
            self.label.place(relx = 0.5, rely = 0.05, anchor="center")
            self.adapt_text(parent)
            self.image_canvas.place(relx=0.5, rely=0.38, relwidth = 0.58, relheight=0.58, anchor="center")
        else : 
    ...
    def adapt_text(self, GUI : ChoiceSituationGUI):
        ...
        self.title = f"Prioriser la valeur \"{GUI.situation.value1.name_fr}\""
        self.label = ctk.CTkLabel(master=self, text=self.title, font = ctk.CTkFont(size=18, weight="bold"))
        self.label.place(relx = 0.5, rely = 0.055, anchor="center")
...
class OptionFrame2(ctk.CTkFrame):
    def __init__(self, parent : ChoiceSituationGUI, _relx, _rely, _relwidth, _relheight):
        ...
        if parent.disp_values :
            self.title = f"Prioriser la valeur \"{parent.situation.value2.name_fr}\""
            self.label = ctk.CTkLabel(master=self, text=self.title, font = ctk.CTkFont(size=18, weight="bold"))
            self.label.place(relx = 0.5, rely = 0.05, anchor="center")
            self.adapt_text(parent)
            self.image_canvas.place(relx=0.5, rely=0.38, relwidth = 0.58, relheight=0.58, anchor="center")
    ...
    def adapt_text(self, GUI : ChoiceSituationGUI):
        self.label.place_forget()
        self.title = f"Prioriser la valeur \"{GUI.situation.value2.name_fr}\""
        self.label = ctk.CTkLabel(master=self, text=self.title, font = ctk.CTkFont(size=18, weight="bold"))
        self.label.place(relx = 0.5, rely = 0.055, anchor="center")
