...
class MainFrame(ctk.CTkFrame):
    def __init__(self, parent: Questionnaire):
        ...
        self.number = ctk.StringVar(value="")
        ...
        self.week_day = ctk.StringVar(value="")
        ...
        self.week_night = ctk.StringVar(value="")
        ...
        self.weekend_day = ctk.StringVar(value="")
        ...
        self.weekend_night = ctk.StringVar(value="")
        ...
        self.residence = ctk.StringVar(value="")
